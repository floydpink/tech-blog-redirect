...
get '/2013/01/note-to-self-could-be-useful-someday.html' do
  redirect "#{ROOT}/2013/01/16/note-to-self-could-be-useful-someday/", 301
end
get '/2013/01/single-click-deployment.html' do
  redirect "#{ROOT}/2013/01/15/single-click-deployment/", 301
end
get '/2012/12/aop-for-logging-in-net.html' do
  redirect "#{ROOT}/2012/12/16/aop-for-logging-in-net/", 301
end
get '/2012/12/lzwCompress.js.html' do
  redirect "#{ROOT}/2012/12/07/lzwCompress.js/", 301
end
get '/2012/12/useful-git-commands.html' do
  redirect "#{ROOT}/2012/12/06/useful-git-commands/", 301
end
get '/2012/11/json-minification.html' do
  redirect "#{ROOT}/2012/11/09/json-minification/", 301
end
get '/2012/09/convert-all-jpgs-in-folder-to-pdfs-with.html' do
  redirect "#{ROOT}/2012/09/05/convert-all-jpgs-in-folder-to-pdfs-with/", 301
end
get '/2012/05/creating-dynamic-types-in-net.html' do
  redirect "#{ROOT}/2012/05/24/creating-dynamic-types-in-net/", 301
end
get '/2012/02/detect-jquery-presence.html' do
  redirect "#{ROOT}/2012/02/02/detect-jquery-presence/", 301
end
get '/2012/02/array-min-max-jquery-map.html' do
  redirect "#{ROOT}/2012/02/01/array-min-max-jquery-map/", 301
end
get '/2010/11/sort-dropdownselect-list-items-using.html' do
  redirect "#{ROOT}/2010/11/10/sort-dropdownselect-list-items-using/", 301
end
get '/2009/08/displaying-version-for-microsoft.html' do
  redirect "#{ROOT}/2009/08/26/displaying-version-for-microsoft/", 301
end
get '/2009/06/adding-in-new-window-link-on-sharepoint.html' do
  redirect "#{ROOT}/2009/06/23/adding-in-new-window-link-on-sharepoint/", 301
end
...
get '/blog/:year/:month/:day/:article' do |year, month, day, article|
  redirect "#{ROOT}/#{year}/#{month}/#{day}/#{article}", 301
end
...
get '/' do
  redirect "#{ROOT}/categories/technical/", 301
end
